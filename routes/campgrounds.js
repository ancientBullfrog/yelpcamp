...
const { showCampground, renderNewForm, createCampground, renderEditForm, patchCampground, deleteCampground, showAllCampgrounds } = require('../controllers/campgrounds');
